...
public class Main {
    ...
    public static void main(String[] args) {
        //Exercitii
//        1. Declara un int si transforma-l in string
...
//        IntExamples.exempleDeInt();
        ...
        //6. Afla media urmatoarelor numere: 20, 30, 5, 3, 77, 1

        //7. Afla perimetrul unui dreptunghi care are laturile de 20 si 30
